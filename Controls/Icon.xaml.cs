...
namespace FontAwesome.Wpf.Controls
{
    ...
    {
        private static FontFamily _Brands = new FontFamily(new Uri("pack://application:,,,/wpf.fontawesome5;component/"), "./Font-Awesome/otfs/#Font Awesome 5 Brands Regular");
        private static FontFamily _Solid = new FontFamily(new Uri("pack://application:,,,/wpf.fontawesome5;component/"), "./Font-Awesome/otfs/#Font Awesome 5 Free Solid");
        private static FontFamily _Regular = new FontFamily(new Uri("pack://application:,,,/wpf.fontawesome5;component/"), "./Font-Awesome/otfs/#Font Awesome 5 Free Regular");
